    ...
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow-md overflow-hidden">
        <div className="md:w-1/2 p-8">
          ...
          <p className="mb-8">We are glad to see you back with us</p>
          <div className="mb-4">
          ...
          <button className="bg-black text-white font-bold py-2 px-4 rounded mb-4">
            NEXT
          </button>
